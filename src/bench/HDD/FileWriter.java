...
public class FileWriter {
    ...
    private static final int MIN_BUFFER_SIZE = 2*1024 ; // KB
    private static final int MAX_BUFFER_SIZE = 1024 * 1024 * 64; // MB
    private static final long MIN_FILE_SIZE = 1000 * 1024 * 1024 ; // MB
    ...
    private void writeFile(String fileName, int bufferSize,
        ...
        //FileOutputStream fout = new FileOutputStream("C:\\faculta\\CO:\\testout.txt");
    ...
    private void printStats(String fileName, long totalBytes, int bufferSize) {
        ...
        double seconds = time/1000000000.0; // calculated from timer's 'time'
        double megabytes = totalBytes / 1048576.0; //2 at power 20
